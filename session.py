...
def spinner(x):
    if x == "tele":
        ...
        print("Checking if python-telegram-bot is installed...")
    for _ in range(3):
        for frame in r"-\|/-\|/":
...
def ptb_session():
    try:
        ...
        x = "\bFound an existing installation of python-telegram-bot...\nSuccessfully Imported.\n\n"
    except ImportError:
        print("Installing python-telegram-bot...")
        os.system("pip install python-telegram-bot")
        x = "\bDone. Installed and imported python-telegram-bot."
        from telegram.ext import Application
    ...
    # get bot token
    print("Get your Bot Token from @BotFather on Telegram to proceed.\n\n")
    ...
    try:
        ...
        print("\nNOTE: Keep this token secure and never share it publicly!")
        return
    except Exception as er:
        print("Error occurred while initializing the bot.")
        print(er)
        print("Please make sure you entered a valid bot token.")
...
def main():
    ...
    try:
        type_of_ss = int(
            input(
                "\nUltroid supports multiple session types.\n\nWhich session do you want to generate?\n1. Telethon Session.\n2. Pyrogram Session.\n3. Python-Telegram-Bot Session.\n\nEnter choice:  "
            )
        )
